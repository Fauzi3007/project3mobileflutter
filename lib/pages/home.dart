                  ...
                  children: [
                    _buildMenuItem(Icons.calendar_today, 'Data Absensi', () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DataAbsensiPage()),
                      );
                    }),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(
              icon,
              size: 40, // Increase the size to make it bigger
              color: Colors.blue,
            ),
            const SizedBox(
                height: 8), // Add some spacing between the icon and the title
            Text(
              title,
              style: const TextStyle(
                fontSize: 14, // Decrease the font size to make it smaller
                color: Colors.black,
              ),
            ),
          ],
